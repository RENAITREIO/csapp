...
void transpose_61x67(int M, int N, int A[N][M], int B[M][N])
{
    ...
    //             if (i % 8 == 0)
    //             {
    //                 a1 = A[i][i];a2 = A[i+1][i+1];a3 = A[i+2][i+2];a4 = A[i+3][i+3];
    //                 a5 = A[i+4][i+4];a6 = A[i+5][i+5];a7 = A[i+6][i+6];a8 = A[i+7][i+7];
    //             }
    //             else if ((i - 7) % 8 == 0)
    //             {
    //                 B[i-7][i-7] = a1;B[i-6][i-6] = a2;B[i-5][i-5] = a3;B[i-4][i-4] = a4;
    //                 B[i-3][i-3] = a5;B[i-2][i-2] = a6;B[i-1][i-1] = a7;B[i][i] = a8;
    //             }
    //             continue;
    //         }
    //         B[j][i] = A[i][j];
